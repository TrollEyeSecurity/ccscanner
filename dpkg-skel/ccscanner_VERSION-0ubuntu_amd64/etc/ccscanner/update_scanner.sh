...
sudo systemctl stop ccscanner.service cc-dast-taskmanager.service cc-gvm-taskmanager.service cc-infrastructre-taskmanager.service cc-nmap-taskmanager.service cc-sast-taskmanager.service cc-url-taskmanager.service

sudo DEBIAN_FRONTEND=noninteractive apt update && sudo DEBIAN_FRONTEND=noninteractive apt dist-upgrade -y

docker_commands

sudo systemctl enable --now ccscanner.service cc-dast-taskmanager.service cc-gvm-taskmanager.service cc-infrastructre-taskmanager.service cc-nmap-taskmanager.service cc-sast-taskmanager.service cc-url-taskmanager.service
